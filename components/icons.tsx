// Lucide-style line icons (24x24 viewBox, 2px stroke, round caps/joins, no
// fill, currentColor) — matching the Nook design system iconography.
...
export function SunIcon({ size = 16, className }: IconProps) {
  return (
    <svg width={size} height={size} className={className} {...base} aria-hidden>
...
/** Google "G" mark — the one place we use brand color, per the login button. */
