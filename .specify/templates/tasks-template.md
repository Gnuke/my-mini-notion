...
- Tests MUST be written and verified to FAIL before implementation (constitution Principle I)
...
```bash
# Launch all tests for User Story 1 together (write first, verify they FAIL):
